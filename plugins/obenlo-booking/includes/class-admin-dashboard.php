...
?>
        <div class="obenlo-dashboard-container admin-mode" data-version="1.4.0">
            <style>
                ...
                .admin-table th { background: transparent; padding: 15px; text-align: left; font-weight: 700; color: #888; text-transform: uppercase; font-size: 0.75rem; letter-spacing: 1px; }
                .admin-table td { background: #fff; padding: 15px; color: #444; font-size: 0.95rem; vertical-align: middle; border-top: 1px solid #f0f0f0; border-bottom: 1px solid #f0f0f0; transition: all 0.2s; }
            ...
            <div class="dashboard-content">
                ...
                <?php
                switch ($tab) {
                    case 'listings':      $this->render_listings_tab(); break;
                    case 'users':         $this->render_users_tab(); break;
                    case 'verifications': $this->render_verifications_tab(); break;
