            ...
            <div class="obenlo-guest-guide">
                ...
                <div style="display:grid; gap:30px;">
                    ...
                    <div style="background:#fff; border:1px solid #eee; border-radius:16px; padding:30px; box-shadow: 0 4px 15px rgba(0,0,0,0.02);">
                        ...
                        <p style="color:#444; line-height:1.6;">Because Obenlo supports many types of businesses, the reservation widget depends on what you are booking:</p>
                        <ul style="color:#444; line-height:1.6; padding-left:20px;">
                            <li><strong>Stays & Hotels:</strong> You will see a traditional calendar. Select your Check-In and Check-Out dates.</li>
