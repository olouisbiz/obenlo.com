...
<div class="static-page-content" style="max-width: 800px; margin: 0 auto; padding: 80px 20px; line-height: 1.8; color: #444;">
    ...
    <h2>2. User Registration and Eligibility</h2>
    <p>To use certain features of Obenlo, you must register for an account. You agree to provide accurate, current, and complete information during the registration process and to update such information to keep it accurate, current, and complete. You are responsible for safeguarding your account credentials and for all activities that occur under your account.</p>

    <h2>3. Hosting and Guest Responsibilities</h2>
