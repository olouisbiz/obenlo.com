...
<div class="static-page-header" style="background: #f7f7f7; padding: 60px 20px; text-align: center; border-bottom: 1px solid #eee;">
    <h1 style="font-size: 3em;"><?php echo __('Terms of Service', 'obenlo'); ?></h1>
    <p style="color: #666; font-size: 1.2em;"><?php echo __('The rules and guidelines for using the Obenlo platform.', 'obenlo'); ?></p>
</div>

<div class="static-page-content" style="max-width: 800px; margin: 0 auto; padding: 80px 20px; line-height: 1.8; color: #444;">
    
    <h2><?php echo __('1. Acceptance of Terms', 'obenlo'); ?></h2>
    <p><?php echo __('By accessing and using the Obenlo platform, you agree to be bound by these Terms of Service, our Privacy Policy, and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site.', 'obenlo'); ?></p>

    <h2><?php echo __('2. User Registration and Eligibility', 'obenlo'); ?></h2>
    <p><?php echo __('To use certain features of Obenlo, you must register for an account. You agree to provide accurate, current, and complete information during the registration process and to update such information to keep it accurate, current, and complete. You are responsible for safeguarding your account credentials and for all activities that occur under your account.', 'obenlo'); ?></p>

    <h2><?php echo __('3. Hosting and Guest Responsibilities', 'obenlo'); ?></h2>
    <p><?php echo __('As a Host, you are responsible for the accuracy of your listings, compliance with all local laws and regulations, and the quality and safety of the services or spaces you provide. As a Guest, you agree to follow the rules and guidelines set by the Host and to treat their property and services with respect.', 'obenlo'); ?></p>

    <h2><?php echo __('4. Booking, Payments, and Fees', 'obenlo'); ?></h2>
    ...
    <h2><?php echo __('5. Cancellations, Refunds, and Mediation', 'obenlo'); ?></h2>
    ...
    <h2><?php echo __('6. User Content and Prohibited Conduct', 'obenlo'); ?></h2>
    ...
    <h2><?php echo __('7. Platform Usage and Intellectual Property', 'obenlo'); ?></h2>
    ...
    <h2><?php echo __('8. Limitation of Liability and Indemnification', 'obenlo'); ?></h2>
    ...
    <h2><?php echo __('9. Dispute Resolution and Governing Law', 'obenlo'); ?></h2>
