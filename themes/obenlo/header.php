    ...
    <div class="header-inner">
        ...
        <div class="header-user-menu" id="headerUserMenu">
            <div class="header-mobile-actions">
                <a href="<?php echo esc_url(home_url('/wishlists')); ?>" aria-label="<?php esc_attr_e('Wishlists', 'obenlo'); ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" style="width: 22px; height: 22px; display: block;"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
                </a>
                <a href="<?php echo esc_url(home_url('/messages')); ?>" aria-label="<?php esc_attr_e('Messages', 'obenlo'); ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" style="width: 22px; height: 22px; display: block;"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9M13.73 21a2 2 0 0 1-3.46 0"/></svg>
                </a>
            </div>
