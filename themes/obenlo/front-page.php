...
<main id="primary" class="site-main site-content" style="max-width: 1400px; margin: 0 auto; padding: 20px 40px;">
    ...
    <?php /* ── MOBILE: Sticky search pill + category filter row ── */ ?>
    <div class="mobile-search-wrapper">
        ...
        <?php /* Search pill */ ?>
        <a href="<?php echo esc_url($search_url); ?>" class="mobile-search-pill" id="mobile-search-pill-home" aria-label="<?php esc_attr_e('Search listings', 'obenlo'); ?>">
            <span class="mobile-search-pill-content">
                ...
                <span class="mobile-search-pill-text"><?php esc_html_e('Stays, services, experiences…', 'obenlo'); ?></span>
            </span>
        ...
        <?php /* Category scroll pills */ ?>
        <div class="mobile-categories-scroll" role="list">
            <a href="<?php echo esc_url($stay_link); ?>" class="mobile-category-pill cat-stay" role="listitem">
                <span class="cat-dot"></span><?php esc_html_e('Stays', 'obenlo'); ?>
            </a>
            <a href="<?php echo esc_url($exp_link); ?>" class="mobile-category-pill cat-experience" role="listitem">
                <span class="cat-dot"></span><?php esc_html_e('Experiences', 'obenlo'); ?>
            </a>
            <a href="<?php echo esc_url($evt_link); ?>" class="mobile-category-pill cat-event" role="listitem">
                <span class="cat-dot"></span><?php esc_html_e('Events', 'obenlo'); ?>
            </a>
            <a href="<?php echo esc_url($srv_link); ?>" class="mobile-category-pill cat-service" role="listitem">
                <span class="cat-dot"></span><?php esc_html_e('Services', 'obenlo'); ?>
            </a>
        </div>
